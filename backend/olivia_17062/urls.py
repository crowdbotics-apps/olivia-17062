"""olivia_17062 URL Configuration
...
admin.site.site_header = "Olivia"
admin.site.site_title = "Olivia Admin Portal"
admin.site.index_title = "Olivia Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Olivia API",
        default_version="v1",
        description="API documentation for Olivia App",
    ),
    public=True,
